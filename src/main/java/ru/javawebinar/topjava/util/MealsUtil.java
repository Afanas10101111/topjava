...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 28, 10, 0), "SomeFoodForSecondUser", 500),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 25, 10, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 25, 13, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 25, 20, 0), "Ужин", 500),

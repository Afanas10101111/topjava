...
<hr>
<h2>Meals</h2>
<h4><a href="update.jsp">Add Meal</a></h4>
<table>
    <tr>
        <th>Date</th>
        <th>Description</th>
    ...
    <c:forEach var="meal" items="${mealsTo}">
        ...
        <tr style="color:${mealColor}">
            ...
            <th>${meal.calories}</th>
            <th><a href="extended-meals?action=update&id=${meal.id}">Update</a></th>
            <th><a href="extended-meals?action=delete&id=${meal.id}">Delete</a></th>
        </tr>
    </c:forEach>
</table>
</body>
